...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "templated-agent-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "templated-agent-ts-worker");
