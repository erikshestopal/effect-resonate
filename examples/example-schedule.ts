...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-schedule-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-schedule-ts-worker");
