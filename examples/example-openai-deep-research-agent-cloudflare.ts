...
const group = Protocol.WorkerGroup.make(
  process.env.RESONATE_GROUP ?? "example-openai-deep-research-agent-cloudflare-ts",
);
const pid = Protocol.ProcessId.make(
  process.env.RESONATE_PID ?? "example-openai-deep-research-agent-cloudflare-ts-worker",
);
