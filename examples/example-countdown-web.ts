...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-countdown-web-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-countdown-web-ts-worker");
