...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-nextjs-ecommerce-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-nextjs-ecommerce-ts-worker");
