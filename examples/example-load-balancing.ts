...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-load-balancing-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-load-balancing-ts-worker");
