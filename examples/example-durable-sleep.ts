...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-durable-sleep-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-durable-sleep-ts-worker");
