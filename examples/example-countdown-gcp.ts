...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-countdown-gcp-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-countdown-gcp-ts-worker");
