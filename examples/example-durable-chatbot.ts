...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-durable-chatbot-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-durable-chatbot-ts-worker");
