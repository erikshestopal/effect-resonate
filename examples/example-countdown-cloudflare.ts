...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-countdown-cloudflare-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-countdown-cloudflare-ts-worker");
