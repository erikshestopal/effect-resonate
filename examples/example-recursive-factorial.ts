...
const group = Protocol.WorkerGroup.make(process.env.RESONATE_GROUP ?? "example-recursive-factorial-ts");
const pid = Protocol.ProcessId.make(process.env.RESONATE_PID ?? "example-recursive-factorial-ts-worker");
