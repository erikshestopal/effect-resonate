...
| Same codec path for param AND value, including rejections                                              | 02        |       | todo   |
| Headers always accompany data; `resonate:schema` header written                                        | 02        |       | todo   |
...
| Tag vocabulary: `resonate:target/origin/parent/branch/prefix/scope/timer` (TS/Rust consensus)          | 01, 12    |       | todo   |
